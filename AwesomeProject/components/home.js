...
const COURSESDATA = [
  ...
  {
    id: 2,
    courseName: 'Phân tích & thiết kế HĐT',
    courseCode: 'INT3306',
    averageRate: 4,
    teacher1: 'Nguyễn Văn C',
    teacher2: 'Nguyễn Văn D',
  },
  {
    id: 3,
    ...
    courseCode: 'INT3306',
    averageRate: 5,
    teacher1: 'Nguyễn Văn E',
    teacher2: 'Nguyễn Văn F',
  },
  {
    id: 4,
...
function HomeScreen() {
  ...
  return (
    <>
      ...
      />
      <ScrollView>{renderCourses(filterText)}</ScrollView>
    </>
  );
}
