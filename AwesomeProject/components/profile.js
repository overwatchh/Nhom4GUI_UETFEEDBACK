...
const USERDATA = [
    {
      ...
      email: 'emailcuatuan',
      passWord: '123456',
      displayName: 'Nguyễn Đăng Tuấn',
    },
    {
      id: 2,
      email: 'emailcuathi',
      passWord: '123456',
      displayName: 'Bùi Anh Thi',
    },
    {
      id: 3,
      email: 'emailcuathinh',
      passWord: '123456',
      displayName: 'Nguyễn Đức Thịnh',
    },
    {
      id: 4,
      email: 'emailcuadat',
      passWord: '123456',
      displayName: 'Ngô Quốc Đạt',
    },
    {
      id: 5,
      email: 'emailcuadat',
      passWord: '123456',
      displayName: 'Thân Chí Đạt',
    },
  ],
  usersInfo = StyleSheet.create({
    container: {
...
function USERS() {
  ...
  return (
    <>
      ...
      />
      <ScrollView>{renderUsers(filterText)}</ScrollView>
    </>
  );
}
